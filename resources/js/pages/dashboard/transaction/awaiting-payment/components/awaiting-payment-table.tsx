...
interface AwaitingPaymentTableProps {
  orders: Order[];
...
export function AwaitingPaymentTable({
  ...
  const columns: Column<Order>[] = [
    ...
    },
    {
      ...
      className: "text-center",
      render: (_value, order) => (
        <Badge intent="warning" className="font-medium">
          Awaiting Payment
        </Badge>
      ),
    },
  ...
  return (
    <>
      <Datatable
        ...
        onSort={handleSort}
        sortDescriptor={sortDescriptor}
        emptyMessage="No orders awaiting payment. Orders will appear here once customers place them."
        striped
      />
      <DetailDialog
        order={selectedOrder}
