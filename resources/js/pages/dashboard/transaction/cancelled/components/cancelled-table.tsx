...
export function CancelledTable({
  ...
  const columns: Column<Order>[] = [
    ...
    },
    {
      ...
      className: "text-center",
      render: (_value, order) => (
        <Badge intent="danger" className="font-medium">
          Cancelled
        </Badge>
      ),
    },
    {
      ...
      className: "text-center",
      render: (_value, order) => (
        <Badge intent="secondary" className="font-medium capitalize">
    ...
    },
    {
      ...
      render: (_value, order) => (
        <div className="text-sm text-neutral-600 dark:text-neutral-300">
          {order.cancelled_at
            ? formatDate(new Date(order.cancelled_at), "dd MMM yyyy, HH:mm")
            : "-"}
        </div>
      ),
    },
