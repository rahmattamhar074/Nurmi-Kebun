...
import { AdminCancelOrderTrigger } from "../../components/admin-cancel-order-trigger";

interface AwaitingConfirmationTableProps {
  orders: Order[];
...
export function AwaitingConfirmationTable({
  orders,
  pagination,
  loading = false,
  onPageChange,
  onSort,
  sortDescriptor,
}: AwaitingConfirmationTableProps) {
  ...
  const columns: Column<Order>[] = [
    ...
    },
    {
      ...
      className: "text-center",
      render: (_value, order) => (
        <Badge intent="info" className="font-medium">
          Awaiting Confirmation
        </Badge>
      ),
    },
    {
      key: "payment_uploaded_at",
