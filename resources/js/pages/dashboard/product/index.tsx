...
import { CreateProductTrigger } from "./components/dialog/create";
...
import { IconChevronDown, IconTrash } from "@intentui/icons";
    ...
    <>
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-balance font-semibold text-lg/6">Products</h1>
            <p className="text-neutral-600 dark:text-neutral-400 mt-1">
              Manage your product inventory and details
            </p>
          </div>
          <Link href={route("products.deleted")}>
        ...
        <div className="flex justify-end gap-x-4 items-center py-4">
          <CreateProductTrigger categories={categories} />
